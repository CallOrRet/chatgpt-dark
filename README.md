...
| `DEFAULT_SETTING`                  | 默认设置 | {<br/>  "continuousDialogue": true,<br/>  "archiveSession": false,<br/>  "openaiAPITemperature": 60,<br/>  "systemRule": ""<br/>  "password": ""<br />} |
...
### 多密码文件格式
密码后面的数值是用来保存对应密码已发送了多少次消息的，起始的时候设置为0。后面会每24小时重置一次
```json5
{
  "test123":0,
  "test124":0
